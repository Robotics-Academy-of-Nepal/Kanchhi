...
with open('CAN\\about_can.json', encoding='utf-8') as file:
    intents = json.load(file)
words = pickle.load(open('CAN\\about_can_words.pkl', 'rb'))
classes = pickle.load(open('CAN\\about_can_classes.pkl', 'rb'))
...
model_path = 'CAN\\about_can_best_chatbot.pth'
